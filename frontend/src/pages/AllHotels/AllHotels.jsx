        ...
        <div className="listWrapper mx-3.5 w-full w-max-[1024px] flex gap-[20px]">
          <div className="listSearch sticky p-[10px] rounded-lg flex-1 bg-[#febb02]">
            ...
            <div className="lsItem">
              ...
              <input placeholder={destination ? destination.toString() : ""}
              className='bg-white outline-none rounded-lg ml-2 text-black pl-[10px] ' type="text" />
            </div>
            ...
            <div className="listItem mt-[15px] gap-[10px] flex flex-col">
              ...
              <div className="options mt-[10px] flex justify-between ">
                ...
                <input type="number" min={1} className='optionInput bg-white h-[25px] w-[40px] pl-4' placeholder={options.adult} />
              </div>

              <div className="options mt-[10px] flex justify-between ">
                <span className="optionText">Children</span>
                <input type="number" min={0} className='optionInput bg-white h-[25px] w-[40px] pl-4' placeholder={options.children} />
              </div>

              <div className="options mt-[10px] flex justify-between ">
                <span className="optionText">Room</span>
                <input type="number" min={1} className='optionInput bg-white h-[25px] w-[40px] pl-4' placeholder={options.room} />
              </div>

            </div>
            <button className='listBtn w-full bg-[#003B95] text-white font-bold py-2 px-4 rounded-lg cursor-pointer hover:bg-[#003B95]/80 mt-3'>Search</button>
          </div>
